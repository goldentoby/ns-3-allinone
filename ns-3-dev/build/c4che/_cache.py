...
INCLUDES_SQLITE3 = ['/usr/local/include']
...
SHLIB_MARKER = []
SONAME_ST = []
SQLITE_STATS = '-I/usr/local/include -L/usr/local/lib -lsqlite3\n'
STLIBPATH_ST = '-L%s'
STLIB_MARKER = []
STLIB_ST = '-l%s'
SUDO = ['/usr/bin/sudo']
...
VERSION = '3-dev'
WITH_PYBINDGEN = '/Users/toby.liao/Documents/storage/course/ns3/ns-3-allinone/pybindgen'
cfg_files = ['/Users/toby.liao/Documents/storage/course/ns3/ns-3-allinone/ns-3-dev/build/ns3/config-store-config.h', '/Users/toby.liao/Documents/storage/course/ns3/ns-3-allinone/ns-3-dev/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
