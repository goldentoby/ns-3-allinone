...
static PyMethodDef PyNs3V4TraceRouteHelper_methods[] = {
    {(char *) "Install", (PyCFunction) _wrap_PyNs3V4TraceRouteHelper_Install, METH_VARARGS|METH_KEYWORDS, NULL },
    {(char *) "PrintTraceRouteAt", (PyCFunction) _wrap_PyNs3V4TraceRouteHelper_PrintTraceRouteAt, METH_VARARGS|METH_KEYWORDS|METH_STATIC, "PrintTraceRouteAt(node, stream)\n\ntype: node: ns3::Ptr< ns3::Node >\ntype: stream: ns3::Ptr< ns3::OutputStreamWrapper >" },
    {(char *) "SetAttribute", (PyCFunction) _wrap_PyNs3V4TraceRouteHelper_SetAttribute, METH_VARARGS|METH_KEYWORDS, "SetAttribute(name, value)\n\ntype: name: std::string\ntype: value: ns3::AttributeValue const &" },
...
static PyMethodDef PyNs3V4TraceRoute_methods[] = {
    ...
    {(char *) "Print", (PyCFunction) _wrap_PyNs3V4TraceRoute_Print, METH_VARARGS|METH_KEYWORDS, "Print(stream)\n\ntype: stream: ns3::Ptr< ns3::OutputStreamWrapper >" },
